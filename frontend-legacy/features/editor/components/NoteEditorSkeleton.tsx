...
/**
 * Full-page skeleton matching the NoteEditorSurface layout:
 * cover image → emoji → title → paragraph blocks.
 * Used as the `loading` placeholder for the dynamically imported NoteEditor.
 */
export function NoteEditorSkeleton({ className }: NoteEditorSkeletonProps) {
  return (
    <div
      className={cn(
