...
import { ImageUploadNode as ImageUploadNodeComponent } from "@/features/editor/components/nodes/ImageUploadNode/ImageUploadNode";
...
export interface ImageUploadNodeOptions {
   ...
   * @example { class: 'foo' }
   */
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Tiptap extension options require Record<string, any>
